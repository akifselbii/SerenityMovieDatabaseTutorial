    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your SerenityMovieDatabase Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your SerenityMovieDatabase Account";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "SerenityMovieDatabase";
        }
