...
namespace SerenityMovieDatabase
{
    public class DataMigrations : IDataMigrations
    {
        ...
        private void RunMigrations(string databaseKey)
        {
            ...
            // remove these lines if you want SerenityMovieDatabase migrations to run on your DB.
            ...
            var migrationNamespace = "SerenityMovieDatabase.Migrations." + databaseKey + "DB";
